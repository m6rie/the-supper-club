...
pr9 = PartyRecipe.create(recipe_id: r9.id, party_id: p2.id)
pr10 = PartyRecipe.create(recipe_id: r10.id, party_id: p3.id)
pr10 = PartyRecipe.create(recipe_id: r11.id, party_id: p1.id)
pr10 = PartyRecipe.create(recipe_id: r12.id, party_id: p6.id)
pr10 = PartyRecipe.create(recipe_id: r13.id, party_id: p2.id)
pr10 = PartyRecipe.create(recipe_id: r13.id, party_id: p1.id)
pr10 = PartyRecipe.create(recipe_id: r13.id, party_id: p3.id)
pr10 = PartyRecipe.create(recipe_id: r9.id, party_id: p4.id)
pr10 = PartyRecipe.create(recipe_id: r11.id, party_id: p7.id)
pr10 = PartyRecipe.create(recipe_id: r3.id, party_id: p8.id)
pr10 = PartyRecipe.create(recipe_id: r13.id, party_id: p4.id)
pr10 = PartyRecipe.create(recipe_id: r9.id, party_id: p5.id)
pr10 = PartyRecipe.create(recipe_id: r7.id, party_id: p5.id)
pr10 = PartyRecipe.create(recipe_id: r9.id, party_id: p6.id)
pr10 = PartyRecipe.create(recipe_id: r12.id, party_id: p7.id)
pr10 = PartyRecipe.create(recipe_id: r13.id, party_id: p8.id)
